...
![An Overview of Total Recall](/static/images/total-recall/detail.png)
...
![The Architecture of Total Recall](/static/images/total-recall/framework.png)
...
- **Event Detection**: Identifies key objects and actions in video clips, answering fundamental questions like _“What’s in the video?”_ and _“What happened?”_.
  ![Frame Difference Analysis](/static/images/total-recall/frames.png)
...
- **Multi-Model Processing**:
  ![Florence-2 Results](/static/images/total-recall/parking.png)

  - **Florence-2**: Provides a unified representation for various vision tasks, improving event
    recognition.

  ![LLaVa-Next-Video Inference Results](/static/images/total-recall/llava-next-video.png)
...
![Results of a scene, where an explosion occurs](/static/images/total-recall/detail1.png)
